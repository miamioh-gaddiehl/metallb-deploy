pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/miamioh-gaddiehl/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('gaddiehl-225')   // <---- Change this to match your kubernetes cluster credentials
    }
